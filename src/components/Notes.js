...
const Notes = (props) => {
    ...
    return (
        ...
        {/* <!-- Button trigger modal --> UPDATE WALAAA */}
    ...
    <div className="modal-dialog">
        ...
        <div className={`row my-3 text-${props.text}`}>
            ...
            {notes.map((note)=>{   // maping 
                ...
                title={note.title.length>17?note.title.slice(0,17):note.title} description={note.description.length>54?note.description.slice(0,55):note.description} />; 
